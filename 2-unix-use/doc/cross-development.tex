...
\begin{frame}{Development}{\cod{hello-world-c.c}}
 \begin{tabular}{lllll}
 Host & Target & OS & Toolchain & Verbindung\\
 \hline
 \targetS & \targetS & Debian & mitgeliefert&\\
 \host   & \targetS & Debian & \cod{gcc-5.2.0-arm-64bit.tar.bz2} & sshfs\\
 \host   & \targetS & minimal & \cod{gcc-6.2.0-arm-64bit.tar.gz} & SD-Card\\
 \host   & \targetS & minimal & \cod{gcc-6.2.0-arm-64bit.tar.gz} & curlftpfs\\
 \end{tabular}
\end{frame}
