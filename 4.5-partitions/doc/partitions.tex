...
{\scriptsize\url{https://technet.microsoft.com/en-us/library/cc976786.aspx}}
...
\begin{itemize}
 ...
 \item Mache SD-Karte
 \begin{itemize}
  \item Kopiere {\tiny\url{http://sourceforge.net/projects/fhnw-tinl/files/minimal-distro.img.gz/download}} 
  \item entzippe
  \item kopiere
  \begin{lstlisting}
