...
\begin{frame}{Ethernet}{über USB}
 \begin{itemize}
  ...
  \begin{itemize}
   \item \cod{ifconfig} für den Überblick
   \begin{itemize}
    \item auf dem \target 
	\item auf dem \host
   \end{itemize}
...
\begin{block}{Wichtig}
 \begin{itemize}
  \item \cod{ifconfig} für die Netzschnittstelle
  \item \cod{ping} für den Verbindungstest
 ...
 \begin{itemize}
  \item \cod{nmap} für Portscans
  \item Ein DHCP Server z.B. \cod{dnsmasq}
  \item \cod{wireshark} für die Netzüberwachung
 \end{itemize}
 \end{block}
\end{frame}
